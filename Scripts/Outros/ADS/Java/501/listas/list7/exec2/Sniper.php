    ...
    class Sniper extends Personagem
    {
      ...
      //mostrando informacoes do Piloto
        public function status()
        {
          //mostrando valores
            echo "<br>";
            echo "O <b>Sniper</b> executou a manobra que o Comandante ordenou, dessa forma perdeu ".$this->vEnergia
            ." de energia e ganhou ".$this->vPontos
