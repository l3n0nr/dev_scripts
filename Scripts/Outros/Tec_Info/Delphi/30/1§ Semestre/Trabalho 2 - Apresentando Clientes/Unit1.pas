...
while not(datamodule2.IBTCad.Eof) do
    ...
    s := 'Feminino'
      ...
      s := 'Nao Informado' ;
		showmessage(n + ' é do sexo ' +  Dbedit5.Text ) ;
...
while not(datamodule2.IBTCad.Eof) do
	begin
Showmessage ('O '+ trim(Dbedit2.text ) + 'que é do sexo ' + Dbedit5.text + ',tem '+ Dbedit3.text+ ' anos e mora em ' +Dbedit4.text + 'tem seu cadastro com o numero ' + Dbedit1.text);
 datamodule2.IBTCad.next ;
end;
end ;
