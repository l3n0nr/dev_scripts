...
sleep 5
clear
echo "Olá, este script foi criado para otimização da bateria em Notebook's"
echo "NÃO É RECOMENTADO O SEU USO CASO ESTEJA REALIZANDO TAREFAS COMPLEXAS!"
echo
echo "Você realmente dessa testá-lo? (s ou n)"
echo "|---------------------------------------------------|"
echo "| Digite s para habilitar a otimização da bateria   |"
echo "| Digite n para desabilitar a otimização da bateria |"
echo "|---------------------------------------------------|"
read valor
clear
if [ "$valor" == "s" ]; then
	echo "Você acabou de ativar a otimização da bateria, realizando alterações..."
	sleep 3
	echo
	echo "| ======================================================= |"
	...
	echo
	echo "A sua bateria irá ter uma duração maior.."
	echo "Caso mantenha o uso do notebook constante e com poucas tarefas rodando em paralelo."
	echo
else
	echo "Você acabou de desativar a otimização da bateria"
	sleep 3
	echo "| ======================================================= |"
