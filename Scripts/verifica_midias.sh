...
#podcast's
	tree -f /home/lenonr/Music/Podcast/ > /media/lenonr/lenonr-500GB/Arquivos/Outros/Lista_Podcast.txt
	
#shows
	ls /home/lenonr/Videos/Shows/ | grep - > /media/lenonr/lenonr-500GB/Arquivos/Outros/Lista_Shows.txt